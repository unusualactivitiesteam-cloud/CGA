  ...
  useEffect(() => {
    ...
    if (preselectPlanId && preselectAmount) {
      ...
      if (matchedPlan && !isNaN(amtVal)) {
        ...
        setAmounts(prev => ({
          ...prev,
          [preselectPlanId]: preselectAmount
        }));
      }
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center z-20 px-6 text-center">
                ...
                >
                  <h1 className="text-xl sm:text-2xl md:text-4xl font-black uppercase tracking-[0.15em] text-white font-sans drop-shadow-[0_4px_12px_rgba(0,0,0,0.6)]">
                    Investment <span className="text-[#a4d100]">Plans</span>
                  </h1>
                    ...
                    {plans.filter((p: any) => p.active_status !== false).map((plan: any) => {
                      ...
                      if (plan.id === 'regular') {
                        ...
                        planIcon = (
                          <svg width="64" height="72" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-4 drop-shadow-[0_0_15px_rgba(164,209,0,0.35)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowReg)" stroke="#a4d100" strokeWidth="1.5" />
                            <path d="M32 16L35.5 23.5H43L37 28L39.5 35.5L32 30.5L24.5 35.5L27 28L21 23.5H28.5L32 16Z" fill="#a4d100" />
                            <path d="M26 31L23 45L32 40L41 45L38 31" stroke="#a4d100" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <defs>
                              <radialGradient id="hexGlowReg" cx="50%" cy="50%" r="50%">
                                <stop offset="0%" stopColor="#a4d100" stopOpacity="0.25" />
                                <stop offset="100%" stopColor="#a4d100" stopOpacity="0" />
                              </radialGradient>
                            </defs>
                          </svg>
                        );
                        ...
                        planIcon = (
                          <svg width="64" height="72" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-4 drop-shadow-[0_0_20px_rgba(164,209,0,0.5)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowPrem)" stroke="#a4d100" strokeWidth="2.5" />
                            <path d="M20 42V28L26 33L32 23L38 33L44 28V42H20Z" fill="#a4d100" />
                            <circle cx="20" cy="25" r="2.5" fill="#a4d100" />
                            <circle cx="32" cy="19" r="2.5" fill="#a4d100" />
                            <circle cx="44" cy="25" r="2.5" fill="#a4d100" />
                            <defs>
                              <radialGradient id="hexGlowPrem" cx="50%" cy="50%" r="50%">
                                <stop offset="0%" stopColor="#a4d100" stopOpacity="0.35" />
                                <stop offset="100%" stopColor="#a4d100" stopOpacity="0" />
                              </radialGradient>
                            </defs>
                          </svg>
                        ...
                        planIcon = (
                          <svg width="64" height="72" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-4 drop-shadow-[0_0_15px_rgba(164,209,0,0.35)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowElite)" stroke="#a4d100" strokeWidth="2" />
                            <path d="M32 18L45 28L32 48L19 28L32 18Z" stroke="#a4d100" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                            <path d="M19 28H45" stroke="#a4d100" strokeWidth="1.5" />
                            <path d="M25 23H39" stroke="#a4d100" strokeWidth="1.5" />
                            <defs>
                      ...
                      return (
                        <div 
                          ...
                          onClick={() => {
                            setModalPlan(plan);
                            setModalAmount(plan.min.toString());
                          }}
                          className={cn(
                            ...
                            isPremium 
                              ? "bg-[#090d15] border-2 border-[#a4d100] shadow-[0_0_35px_rgba(164,209,0,0.25)] lg:scale-[1.04] z-10 hover:shadow-[0_0_50px_rgba(164,209,0,0.4)]" 
                              : "bg-[#090d15] border border-white/5 hover:border-[#a4d100]/40 hover:shadow-[0_0_25px_rgba(164,209,0,0.12)] z-0"
                          )}
                        >
                          {isPremium && (
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#a4d100] text-black text-[9px] font-black uppercase tracking-widest px-6 py-1.5 rounded-b-xl shadow-[0_4px_12px_rgba(164,209,0,0.3)] z-20">
                              MOST POPULAR
                            </div>
                          )}
                          ...
                          {plan.id === 'regular' && (
                            <div className="absolute inset-0 pointer-events-none opacity-[0.03] z-0 flex items-end justify-end p-4">
                              <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 180 L50 140 L50 160 L80 110 L80 130 L110 80 L110 100 L140 40 L140 60 L180 20" stroke="#a4d100" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                            </div>
                          )}
                          {plan.id === 'premium' && (
                            <div className="absolute inset-0 pointer-events-none opacity-[0.04] z-0 flex items-center justify-center">
                              <svg width="300" height="300" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="150" cy="150" r="90" stroke="#a4d100" strokeWidth="1" strokeDasharray="3 3" />
                                <circle cx="150" cy="150" r="60" stroke="#a4d100" strokeWidth="1" />
                              </svg>
                            </div>
                          )}
                          {plan.id === 'elite' && (
                            <div className="absolute inset-0 pointer-events-none opacity-[0.03] z-0 flex items-end justify-end p-4">
                              <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 170 L40 150 L70 120 L100 130 L130 90 L160 50 L190 20" stroke="#a4d100" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                            </div>
                          )}
                          ...
                          <div className="relative z-10 flex-1 flex flex-col justify-between h-full">
                            <div className="flex flex-col items-center text-center">
                              ...
                              {/* ROI Box */}
                              <div className="bg-[#05080f]/60 border border-white/5 rounded-2xl p-4 flex items-center gap-4 mb-4 w-full transition-all duration-300 hover:border-[#a4d100]/25 hover:bg-black/40">
                                <div className="w-10 h-10 rounded-full border border-[#a4d100]/30 bg-[#a4d100]/5 flex items-center justify-center text-[#a4d100] shrink-0">
                                ...
                                <div className="flex items-baseline gap-1.5 text-left">
                                  <span className="text-2xl font-black text-[#a4d100] tracking-tight">
                              ...
                              {/* Limits Box */}
                              <div className="bg-[#05080f]/60 border border-white/5 rounded-2xl p-4 flex items-center gap-4 w-full text-left transition-all duration-300 hover:border-[#a4d100]/25 hover:bg-black/40">
                                <div className="w-10 h-10 rounded-full border border-[#a4d100]/30 bg-[#a4d100]/5 flex items-center justify-center text-[#a4d100] shrink-0 font-extrabold text-sm">
                                  $
                                </div>
                                <div>
                            ...
                            <div className="mt-6">
                              <button
                                ...
                                className={cn(
                                  ...
                                  isPremium 
                                    ? "bg-[#a4d100] hover:bg-[#b5e600] text-black shadow-[0_4px_15px_rgba(164,209,0,0.3)] hover:shadow-[0_4px_20px_rgba(164,209,0,0.5)]" 
                                    : "border border-[#a4d100]/30 hover:border-[#a4d100]/60 bg-[#a4d100]/5 hover:bg-[#a4d100]/15 text-[#a4d100] hover:shadow-[0_0_15px_rgba(164,209,0,0.15)]"
                                )}
                              >
                      ...
                      if (plan.id === 'regular') {
                        ...
                        planIcon = (
                          <svg width="44" height="50" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_8px_rgba(164,209,0,0.35)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowRegMob)" stroke="#a4d100" strokeWidth="1.5" />
                            <path d="M32 16L35.5 23.5H43L37 28L39.5 35.5L32 30.5L24.5 35.5L27 28L21 23.5H28.5L32 16Z" fill="#a4d100" />
                            <path d="M26 31L23 45L32 40L41 45L38 31" stroke="#a4d100" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <defs>
                        ...
                        planIcon = (
                          <svg width="44" height="50" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_12px_rgba(164,209,0,0.5)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowPremMob)" stroke="#a4d100" strokeWidth="2.5" />
                            <path d="M32 18L38 28H26L32 18Z" fill="#a4d100" />
                            <circle cx="32" cy="38" r="5" fill="#a4d100" />
                            <circle cx="23" cy="28" r="3" fill="#a4d100" />
                            <circle cx="41" cy="28" r="3" fill="#a4d100" />
                            <defs>
                        ...
                        planIcon = (
                          <svg width="44" height="50" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_8px_rgba(164,209,0,0.35)]">
                            <path d="M32 2L59.7 18V50L32 66L4.3 50V18L32 2Z" fill="url(#hexGlowEliteMob)" stroke="#a4d100" strokeWidth="2" />
                            <path d="M22 22 L32 14 L42 22 L32 44 Z" fill="none" stroke="#a4d100" strokeWidth="1.5" />
                            <path d="M22 22 L42 22 M32 14 L32 44" fill="none" stroke="#a4d100" strokeWidth="1.5" />
                            <defs>
                      ...
                      return (
                        <motion.div 
                          ...
                          className={cn(
                            ...
                            isPremium 
                              ? "bg-[#090d15] border-2 border-[#a4d100] shadow-[0_0_20px_rgba(164,209,0,0.2)] pt-8" 
                              : "bg-[#090d15] border border-white/5"
                          )}
                        >
                          {isPremium && (
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#a4d100] text-black text-[8px] font-black uppercase tracking-widest px-4 py-1.5 rounded-b-xl shadow-[0_4px_10px_rgba(164,209,0,0.3)] z-20 whitespace-nowrap">
                              MOST POPULAR
                            </div>
                          )}
                          ...
                          <div className="relative z-10 flex-1 flex flex-col justify-between min-w-0">
                            <div>
                              ...
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-base font-black text-[#a4d100] tracking-tight">
                                  {((plan.weekday_roi || plan.roi) * 100).toFixed(1)}%
                                </span>
                            ...
                            <div className="mt-3">
                              <button
                                ...
                                className={cn(
                                  ...
                                  isPremium 
                                    ? "bg-[#a4d100] text-black shadow-[0_2px_8px_rgba(164,209,0,0.3)]" 
                                    : "border border-[#a4d100]/30 bg-[#a4d100]/5 text-[#a4d100]"
                                )}
                              >
                  ...
                  {modalPlan && (
                    <div className="fixed inset-0 z-[200] bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
                      <motion.div 
                        ...
                        animate={{ opacity: 1, scale: 1, y: 0 }}
                        exit={{ opacity: 0, scale: 0.95, y: 15 }}
                        className="bg-[#0b0c10] border border-[#a4d100]/30 rounded-2xl max-w-sm w-full p-5 sm:p-6 shadow-[0_0_50px_rgba(164,209,0,0.15)] flex flex-col relative overflow-hidden"
                      >
                        <button 
                          type="button"
                        ...
                        <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#a4d100] to-transparent opacity-50" />

                        <div className="flex flex-col items-center text-center mb-4">
                          <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#a4d100] mb-1">Configure Allocation</span>
                        ...
                        <div className="space-y-4">
                          <div className="bg-white/[0.02] border border-white/5 rounded-xl px-3 py-2 flex items-center justify-between">
                            ...
                            <span className="text-sm font-black text-[#a4d100] italic font-serif">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="relative">
                              ...
                              <input 
                                ...
                                className="w-full bg-white/[0.03] border border-white/10 rounded-xl py-3 pl-8 pr-4 text-lg font-black text-white transition-all outline-none focus:border-[#a4d100] focus:bg-[#a4d100]/5 text-center"
                              />
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-1.5">
                            {PLAN_PRESETS[modalPlan.id]?.map((preset) => (
                              <button
                                key={preset}
                                type="button"
                                onClick={() => setModalAmount(preset.toString())}
                                className={cn(
                                  "py-2 rounded-lg text-center border text-[10px] font-black transition-all cursor-pointer select-none",
                                  parseFloat(modalAmount) === preset 
                                    ? "bg-[#a4d100] border-[#a4d100] text-black shadow-[0_2px_8px_rgba(164,209,0,0.2)]"
                          ...
                          <div className="text-center">
                            <p className="text-[9px] text-white/40 tracking-wider">
                              Range Limits: <span className="text-[#a4d100] font-bold">{formatCurrency(modalPlan.min)}</span> - <span className="text-[#a4d100] font-bold">{formatCurrency(modalPlan.max)}</span>
                            </p>
                          </div>

                          <button 
                            type="button"
                            disabled={!modalAmount || parseFloat(modalAmount) < modalPlan.min || parseFloat(modalAmount) > modalPlan.max}
                            onClick={handleConfirmModal}
                            className={cn(
                              "w-full py-3 rounded-xl text-black font-extrabold text-xs tracking-widest uppercase transition-all shadow-lg flex items-center justify-center gap-1.5 cursor-pointer",
                              (!modalAmount || parseFloat(modalAmount) < modalPlan.min || parseFloat(modalAmount) > modalPlan.max)
                                ? "bg-[#a4d100]/20 text-black/40 cursor-not-allowed"
                                : "bg-[#a4d100] hover:bg-[#b5e600] active:scale-[0.98] shadow-[0_2px_15px_rgba(164,209,0,0.25)]"
                            )}
                          >
            ...
            <div className="max-w-md w-full">
             <div className="p-5 sm:p-6 bg-[#0c0e14] border border-white/10 rounded-2xl space-y-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-gradient-to-b from-white/[0.015] to-transparent border border-white/5 rounded-2xl relative overflow-hidden text-center">
                    ...
                    <div className="absolute top-3 right-3 z-20">
                      <span className="text-[8px] font-black uppercase tracking-wider text-[#a4d100] bg-[#a4d100]/10 border border-[#a4d100]/20 px-2 py-0.5 rounded">
                        {selectedPlan.name}
                      </span>
                    </div>
                    ...
                    <div className="relative mb-2 mt-4">
                      <div className="absolute inset-0 bg-[#a4d100]/5 rounded-full blur-xl pointer-events-none" />
                      <img 
                        src={getRobotForPlan(selectedPlan.id).image} 
                        alt={getRobotForPlan(selectedPlan.id).name} 
                        className="w-14 h-14 sm:w-16 sm:h-16 object-contain drop-shadow-[0_0_15px_rgba(164,209,0,0.15)] relative z-10"
                        referrerPolicy="no-referrer"
                      />
                    </div>
                ...
                <div className="flex items-center gap-2.5 px-1 py-1">
                  ...
                  <label htmlFor="terms" className="text-[9px] sm:text-[10px] font-medium text-slate-400 leading-normal cursor-pointer select-none">
                    ...
                    <Link 
                      ...
                      className="text-[#a4d100] underline hover:text-[#b8eb00] transition-colors"
                ...
                <button 
                  ...
                  className={cn(
                    "w-full py-4 text-white font-bold uppercase tracking-[0.2em] text-[10px] rounded-xl shadow-lg disabled:opacity-20 hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer",
            ...
            <div className="max-w-md w-full">
              <div className="space-y-4">
                 <button 
                   ...
                   className="flex items-center gap-1.5 text-[8px] font-medium text-aura-muted hover:text-white transition-colors"
                 >
                 ...
                 <div className="flex flex-col gap-4">
                   ...
                   <div className="grid grid-cols-3 gap-2 mx-auto w-full">
                     ...
                     <button
                       ...
                       className={cn(
                         "py-2 px-2 rounded-xl border text-center transition-all flex flex-col items-center justify-center gap-1 cursor-pointer",
                         paymentMethod === 'crypto'
                           ? "bg-[#a4d100]/10 border-[#a4d100]/30 shadow-md text-white"
                           : "bg-white/5 border-transparent hover:border-white/10 text-aura-muted hover:text-white"
                       )}
                     >
                       <div className="scale-75 origin-center h-6 flex items-center justify-center">
                         <RealisticBitcoinIcon />
                       </div>
                       <span className="text-[8px] font-black uppercase tracking-wider">Crypto</span>
                     </button>
                     ...
                     >
                       ...
                       <span className="text-[8px] font-black uppercase tracking-wider">Wallet</span>
                     </button>
                   ...
                   <AnimatePresence mode="wait">
                       ...
                       >
                         <div className="flex gap-1.5">
                           {(['usdt', 'erc20', 'btc'] as const).map(t => (
                             <button 
                               ...
                               className={cn(
                                 "flex-1 py-2 rounded-lg text-[9px] font-black uppercase tracking-widest border transition-all cursor-pointer",
                           ...
                           <div className="w-full space-y-2">
                             <div className="bg-white/5 border border-white/5 rounded-xl px-4 py-3 flex items-center justify-between gap-4 shadow-inner">
                               ...
                               <button 
                                 ...
                                 className="text-[9px] font-black text-black bg-[#a4d100] px-3 py-1.5 rounded-lg uppercase tracking-widest cursor-pointer whitespace-nowrap"
                               >
                             ...
                             <div className="p-2 bg-amber-500/10 border border-amber-500/25 rounded-xl text-center">
                               ...
                               {cryptoType === 'erc20' && (
                                 <p className="text-[9px] font-medium text-amber-400 leading-normal">
                                   Please send only ERC-20 network tokens to this address. Transferring to any other network will result in permanent loss of your funds.
                                 </p>
                               )}
                               {cryptoType === 'btc' && (
                                 <p className="text-[9px] font-medium text-amber-400 leading-normal">
                             ...
                             <div className="text-center pt-1">
                               ...
                               <span className="text-sm font-black text-[#a4d100] font-mono">{formatCurrency(confirmedAmount)}</span>
                             </div>
                           </div>
                         </div>
                         <div className="space-y-2">
                           <input 
                             ...
                             className="w-full bg-white/5 border border-white/5 rounded-xl px-4 py-3 text-xs font-mono focus:bg-white/10 focus:border-[#a4d100]/50 outline-none transition-all text-white"
                           />
                         </div>
                       </motion.div>
                     )}
                         ...
                         <div className="flex items-center justify-between p-3.5 bg-white/5 border border-white/5 rounded-2xl">
                           ...
                           {confirmedAmount <= walletBalanceToShow && (
                             <button 
                               ...
                               className="px-3 py-1.5 bg-[#a4d100]/10 hover:bg-[#a4d100]/20 text-[#a4d100] rounded-lg text-[9px] font-black uppercase tracking-widest transition-all active:scale-95 border border-[#a4d100]/20 cursor-pointer"
                             >
                               max
                             </button>
                           )}
                     ...
                     {paymentMethod === 'card' && (
                       ...
                       >
                         <div className="mx-auto w-10 h-10 rounded-full bg-[#a4d100]/10 border border-[#a4d100]/20 flex items-center justify-center text-[#a4d100]">
                           <CreditCard size={20} />
                         </div>
                 ...
                 <button 
                   ...
                   className={cn(
                     "w-full py-3.5 text-white font-black uppercase tracking-[0.25em] text-[9px] rounded-xl shadow-lg disabled:opacity-20 transition-all cursor-pointer",
                     selectedPlan.buttonColor
                   )}
                 >
  ...
  return (
    <div className="py-2.5 px-4 bg-white/[0.03] border border-white/5 rounded-xl flex items-center justify-between w-full">
      ...
      <DynamicBalance 
        ...
        className={cn("text-right font-bold", highlight ? "text-[#a4d100]" : "text-white")}
